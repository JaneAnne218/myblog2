import{_ as s,o as n,c as a,O as p}from"./chunks/framework.a7c31c69.js";const u=JSON.parse('{"title":"pnpmdeploy","description":"pnpmdeploy","frontmatter":{"title":"pnpmdeploy","description":"pnpmdeploy","date":"2023-6-10","tags":["CI/CD"]},"headers":[],"relativePath":"pnpmdeploy.md","filePath":"pnpmdeploy.md","lastUpdated":1690482932000}'),l={name:"pnpmdeploy.md"},e=p(`<h2 id="写一个pnpm的github-action" tabindex="-1">写一个pnpm的github action <a class="header-anchor" href="#写一个pnpm的github-action" aria-label="Permalink to &quot;写一个pnpm的github action&quot;">​</a></h2><div class="language-deploy.yml"><button title="Copy Code" class="copy"></button><span class="lang">deploy.yml</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">name: Deployhahah</span></span>
